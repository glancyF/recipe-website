...
<form class="settingsForm" method="post" action="profile/settings/update-profileApi.php" data-js-form>
    <p class="field" data-js-lock>
    ...
    <fieldset class="radios" data-js-lock>
